...
while True:
    ...
    if user == "3":
        ...
        continue
print("3 iidset kangelast läksid rindele. Nende ülesandeks oli leida ja tappa teispoolsuset tulnud pahalased. Teekonnal ületasid nad maad ja mered. Teekond oli väga pikk kuid ilma tulemusteta. Kuid ühel hommikul avastasid nad pahalased omas elemendis, nad olid parasjagu kogu Eesti metsa põlema panemas. Enne kui nad seda teha jõudsid andsid need 3 Kalevipoega neile kõva lahingu. Hiilisid nad neile lähedale ja peksid neid puupalkidega, kuid see ei töötanud, palgid põlesid neid puudutades ära. Neil tekkis uus idee proovida pahalased järve saada. Selleks kulus neil väga palju jõudu ja aega. Tuli pahalasi lüüa korda mööda järve suunas, saades iga kord neid puudutades said nad põletada. Kuid jõudsid nad lõpuks nii kaugele, et nad said pahalased järve, kus ta kustus ja kaotas oma võimed")
